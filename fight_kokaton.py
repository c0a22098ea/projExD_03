...
class Bomb():
    ...
    爆弾に関するクラス
    """
    _colors = [(250, 0, 0), (255, 255, 0), (0, 255, 0), (0, 255, 255), (0, 0, 255)]
    dires = [-1, 0 ,+1]
    def __init__(self):
        """
        ...
        self._vx, self._vy = random.choice(Bomb.dires),  random.choice(Bomb.dires)

    def update(self, screen: pg.Surface):
        """
        爆弾を速度ベクトルself._vx, self._vyに基づき移動させる
        引数 screen：画面Surfaces
        """
...
class Score():
    ...
    def draw(self, screen):
        text = self.font.render("score:{:04d}".format(self.point), True, (0,0,0))
